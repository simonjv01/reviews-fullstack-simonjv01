...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Review dellLaptop = new Review("Dell Laptop","Computer",technology,"lightweight powerhouse","./css/images/dell.jpg");
        ...
        Review mexicanFood = new Review("Best Mexican Food","El Vaquero",restaurant,"authentic cuisine","./images/mexican.jpg");
